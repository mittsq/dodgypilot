...
class LatControlTorque(LatControl):
  ...
  def update(self, active, CS, VM, params, last_actuators, steer_limited, desired_curvature, desired_curvature_rate, llk):
    ...
    if CS.vEgo < MIN_STEER_SPEED or not active:
      ...
      gravity_adjusted_lateral_accel = desired_lateral_accel - math.cos(CS.kinematicsPitch) * math.sin(params.roll) * ACCELERATION_DUE_TO_GRAVITY
      ...
      freeze_integrator = steer_limited or CS.steeringRateLimited or CS.steeringPressed or CS.vEgo < 5
